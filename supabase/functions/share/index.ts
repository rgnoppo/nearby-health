...
Deno.serve(async (req: Request) => {
  let redirectBase = "https://nearby-health-mu.vercel.app";
  ...
  try {
    ...
    if (paramRedirect) {
      redirectBase = paramRedirect.replace(/\/$/, "");
    }
    ...
    if (type === "clinic") {
      ...
      targetUrl = `${redirectBase}/clinic/${id}`;
      ...
      targetUrl = `${redirectBase}/?category=${id}`;
