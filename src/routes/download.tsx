          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800/80 dark:text-amber-300/80 leading-relaxed">
                التطبيق غير متوفر على Google Play حاليًا، لذلك قد يظهر لك تحذير أثناء التثبيت.
                إذا ظهر التحذير، اضغط «مزيد من التفاصيل» ثم اختر «تثبيت على أي حال» لإكمال التثبيت.
                هذه هي النسخة الرسمية من موقع دليل العيادات.
              </p>
            </div>
          </div>
        </section>
